...
⚠ _a fix was proposed but did not verify (no recovery: bundle size 2.34 MB→2.34 MB vs base 2.20 MB) — no fix PR opened._
...
---
<sub>Baseline `main@c0ffee0` (cached) · driftwatch v0.0.0-test (dist built 2026-08-24 00:00Z) · analysed by deepseek (deepseek-chat) · prompts v1 · 6.6k→510 tokens · ⚠ DEV OVERRIDE: verification measured a substituted diff, not the analysis fix</sub>
