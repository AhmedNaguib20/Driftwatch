...
---
<sub>Baseline `main@c0ffee0` (cached) · driftwatch v0.2.0 · analysed by deepseek (deepseek-chat) · prompts v1 · 6.6k→510 tokens · ⚠ DEV OVERRIDE: verification measured a substituted diff, not the analysis fix</sub>
